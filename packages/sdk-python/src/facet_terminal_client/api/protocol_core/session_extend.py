...
from ...models.session_extend_request import SessionExtendRequest
from ...models.session_extend_response import SessionExtendResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | SessionExtendResponse | None:
    if response.status_code == 200:
        response_200 = SessionExtendResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | SessionExtendResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | SessionExtendResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | SessionExtendResponse | None:
    """ Extend a previously opened session.
    ...
    Returns:
        FacetErrorEnvelope | SessionExtendResponse
     """
