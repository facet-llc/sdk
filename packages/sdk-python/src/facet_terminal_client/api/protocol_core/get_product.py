...
from ...models.get_product_request import GetProductRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetProductResponse | None:
    if response.status_code == 200:
        response_200 = GetProductResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetProductResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetProductResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetProductResponse | None:
    """ Retrieve full product detail (description, origin, HTS, documents).
    ...
    Returns:
        FacetErrorEnvelope | GetProductResponse
     """
