...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> DiscoverResponse | FacetErrorEnvelope | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[DiscoverResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[DiscoverResponse | FacetErrorEnvelope]:
    """ Search the Universal Business Index for businesses/services (semantic + geo + edge filters); returns
    ranked listings each with the business's Terminal URL.
...
def sync(
    *,
...
) -> DiscoverResponse | FacetErrorEnvelope | None:
    """ Search the Universal Business Index for businesses/services (semantic + geo + edge filters); returns
    ranked listings each with the business's Terminal URL.
    ...
    Returns:
        DiscoverResponse | FacetErrorEnvelope
     """
