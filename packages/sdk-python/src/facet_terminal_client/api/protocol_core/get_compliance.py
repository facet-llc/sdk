...
from ...models.get_compliance_request import GetComplianceRequest
from ...models.get_compliance_response import GetComplianceResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetComplianceResponse | None:
    if response.status_code == 200:
        response_200 = GetComplianceResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetComplianceResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetComplianceResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetComplianceResponse | None:
    """ Allergen / FSMA 204 / certification compliance for a product.
    ...
    Returns:
        FacetErrorEnvelope | GetComplianceResponse
     """
