...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CapabilitiesResponse | FacetErrorEnvelope | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CapabilitiesResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[CapabilitiesResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> CapabilitiesResponse | FacetErrorEnvelope | None:
    """ Declared tools + commerce capabilities + rate-limit posture.
    ...
    Returns:
        CapabilitiesResponse | FacetErrorEnvelope
     """
