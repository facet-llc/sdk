...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | WhoamiResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | WhoamiResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | WhoamiResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | WhoamiResponse | None:
    """ Echo back the authenticated agent identifier.
    ...
    Returns:
        FacetErrorEnvelope | WhoamiResponse
     """
