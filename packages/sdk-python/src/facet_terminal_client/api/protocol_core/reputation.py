...
from ...models.reputation_request import ReputationRequest
from ...models.reputation_response import ReputationResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | ReputationResponse | None:
    if response.status_code == 200:
        response_200 = ReputationResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | ReputationResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | ReputationResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | ReputationResponse | None:
    """ Aggregate cross-site reputation for an agent identifier.
    ...
    Returns:
        FacetErrorEnvelope | ReputationResponse
     """
