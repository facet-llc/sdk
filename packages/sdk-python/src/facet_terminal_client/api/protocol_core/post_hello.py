...
from ...models.hello_response import HelloResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | HelloResponse | None:
    if response.status_code == 200:
        response_200 = HelloResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | HelloResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | HelloResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | HelloResponse | None:
    """ Smoke-probe endpoint that returns a verified-at timestamp.
    ...
    Returns:
        FacetErrorEnvelope | HelloResponse
     """
