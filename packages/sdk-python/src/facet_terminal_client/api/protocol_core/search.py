...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | SearchResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | SearchResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | SearchResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | SearchResponse | None:
    """ Search the catalog by query / category / tags.
    ...
    Returns:
        FacetErrorEnvelope | SearchResponse
     """
