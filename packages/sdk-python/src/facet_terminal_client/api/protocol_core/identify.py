...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | IdentifyResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | IdentifyResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | IdentifyResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | IdentifyResponse | None:
    """ Identify the calling agent + open a session.
    ...
    Returns:
        FacetErrorEnvelope | IdentifyResponse
     """
