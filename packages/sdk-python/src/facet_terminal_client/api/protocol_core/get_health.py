...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | HealthResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | HealthResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | HealthResponse]:
    """ Liveness probe.
...
def sync(
    *,
...
) -> FacetErrorEnvelope | HealthResponse | None:
    """ Liveness probe.
    ...
    Returns:
        FacetErrorEnvelope | HealthResponse
     """
