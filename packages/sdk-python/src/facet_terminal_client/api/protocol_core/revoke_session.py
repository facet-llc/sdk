...
from ...models.revoke_session_request import RevokeSessionRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | RevokeSessionResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | RevokeSessionResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | RevokeSessionResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | RevokeSessionResponse | None:
    """ Revoke one of the caller's sessions by id.
    ...
    Returns:
        FacetErrorEnvelope | RevokeSessionResponse
     """
