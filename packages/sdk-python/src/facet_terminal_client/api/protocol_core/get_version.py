...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | VersionResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | VersionResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | VersionResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | VersionResponse | None:
    """ Terminal + protocol version information.
    ...
    Returns:
        FacetErrorEnvelope | VersionResponse
     """
