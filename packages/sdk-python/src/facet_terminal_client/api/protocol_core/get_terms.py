...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | TermsResponse | None:
    if response.status_code == 200:
        response_200 = TermsResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | TermsResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | TermsResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | TermsResponse | None:
    """ Pricing, SLA, data retention, and support terms.
    ...
    Returns:
        FacetErrorEnvelope | TermsResponse
     """
