...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | ListSessionsResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | ListSessionsResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | ListSessionsResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | ListSessionsResponse | None:
    """ List the caller's open sessions.
    ...
    Returns:
        FacetErrorEnvelope | ListSessionsResponse
     """
