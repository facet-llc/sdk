...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CancelReservationResponse | FacetErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = CancelReservationResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CancelReservationResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[CancelReservationResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> CancelReservationResponse | FacetErrorEnvelope | None:
    """ Cancel an outstanding reservation before settlement.
    ...
    Returns:
        CancelReservationResponse | FacetErrorEnvelope
     """
