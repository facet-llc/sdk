...
from ...models.get_document_request import GetDocumentRequest
from ...models.get_document_response import GetDocumentResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetDocumentResponse | None:
    if response.status_code == 200:
        response_200 = GetDocumentResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetDocumentResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetDocumentResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetDocumentResponse | None:
    """ Retrieve a document descriptor + URL by id.
    ...
    Returns:
        FacetErrorEnvelope | GetDocumentResponse
     """
