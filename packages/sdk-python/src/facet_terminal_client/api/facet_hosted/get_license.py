...
from ...models.get_license_request import GetLicenseRequest
from ...models.get_license_response import GetLicenseResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetLicenseResponse | None:
    if response.status_code == 200:
        response_200 = GetLicenseResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetLicenseResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetLicenseResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetLicenseResponse | None:
    """ Retrieve one of the caller's content licenses by id.
    ...
    Returns:
        FacetErrorEnvelope | GetLicenseResponse
     """
