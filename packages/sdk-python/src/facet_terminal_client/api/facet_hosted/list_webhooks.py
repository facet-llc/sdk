...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | ListWebhooksResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | ListWebhooksResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | ListWebhooksResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | ListWebhooksResponse | None:
    """ List the calling agent's webhook subscriptions.
    ...
    Returns:
        FacetErrorEnvelope | ListWebhooksResponse
     """
