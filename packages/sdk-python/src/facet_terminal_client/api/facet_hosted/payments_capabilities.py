...
from ...models.payments_capabilities_response import PaymentsCapabilitiesResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | PaymentsCapabilitiesResponse | None:
    if response.status_code == 200:
        response_200 = PaymentsCapabilitiesResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | PaymentsCapabilitiesResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | PaymentsCapabilitiesResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | PaymentsCapabilitiesResponse | None:
    """ Registered rails + verifier kinds.
    ...
    Returns:
        FacetErrorEnvelope | PaymentsCapabilitiesResponse
     """
