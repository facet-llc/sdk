...
from ...models.payments_route_request import PaymentsRouteRequest
from ...models.payments_route_response import PaymentsRouteResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | PaymentsRouteResponse | None:
    if response.status_code == 200:
        response_200 = PaymentsRouteResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | PaymentsRouteResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | PaymentsRouteResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | PaymentsRouteResponse | None:
    """ Read-only rail-sniff introspection.
    ...
    Returns:
        FacetErrorEnvelope | PaymentsRouteResponse
     """
