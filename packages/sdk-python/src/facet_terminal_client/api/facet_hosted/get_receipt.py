...
from ...models.get_receipt_request import GetReceiptRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetReceiptResponse | None:
    if response.status_code == 200:
        response_200 = GetReceiptResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetReceiptResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetReceiptResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetReceiptResponse | None:
    """ Mint a verifiable JWS settlement receipt for an order you own.
    ...
    Returns:
        FacetErrorEnvelope | GetReceiptResponse
     """
