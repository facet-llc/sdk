...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CancelSubscriptionResponse | FacetErrorEnvelope | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CancelSubscriptionResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[CancelSubscriptionResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> CancelSubscriptionResponse | FacetErrorEnvelope | None:
    """ Cancel a subscription.
    ...
    Returns:
        CancelSubscriptionResponse | FacetErrorEnvelope
     """
