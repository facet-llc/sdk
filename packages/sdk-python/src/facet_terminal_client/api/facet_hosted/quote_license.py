...
from ...models.quote_license_request import QuoteLicenseRequest
from ...models.quote_license_response import QuoteLicenseResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | QuoteLicenseResponse | None:
    if response.status_code == 200:
        response_200 = QuoteLicenseResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | QuoteLicenseResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | QuoteLicenseResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | QuoteLicenseResponse | None:
    """ Quote the price + TTL for a content license scope.
    ...
    Returns:
        FacetErrorEnvelope | QuoteLicenseResponse
     """
