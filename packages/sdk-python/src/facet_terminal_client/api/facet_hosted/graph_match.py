...
from ...models.graph_match_request import GraphMatchRequest
from ...models.graph_match_response import GraphMatchResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GraphMatchResponse | None:
    if response.status_code == 200:
        response_200 = GraphMatchResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GraphMatchResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GraphMatchResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GraphMatchResponse | None:
    """ Semantic-similarity match against the knowledge graph.
    ...
    Returns:
        FacetErrorEnvelope | GraphMatchResponse
     """
