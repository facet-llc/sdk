...
from ...models.get_reservation_request import GetReservationRequest
from ...models.get_reservation_response import GetReservationResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetReservationResponse | None:
    if response.status_code == 200:
        response_200 = GetReservationResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetReservationResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetReservationResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetReservationResponse | None:
    """ Retrieve one of the caller's reservations by id.
    ...
    Returns:
        FacetErrorEnvelope | GetReservationResponse
     """
