...
from ...models.order_history_request import OrderHistoryRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | OrderHistoryResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | OrderHistoryResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | OrderHistoryResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | OrderHistoryResponse | None:
    """ List historical orders with cursor pagination.
    ...
    Returns:
        FacetErrorEnvelope | OrderHistoryResponse
     """
