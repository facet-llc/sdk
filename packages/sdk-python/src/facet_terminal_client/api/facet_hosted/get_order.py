...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetOrderResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetOrderResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetOrderResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetOrderResponse | None:
    """ Retrieve a settled order by id.
    ...
    Returns:
        FacetErrorEnvelope | GetOrderResponse
     """
