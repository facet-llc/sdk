...
from ...models.cancel_booking_request import CancelBookingRequest
from ...models.cancel_booking_response import CancelBookingResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CancelBookingResponse | FacetErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = CancelBookingResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CancelBookingResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[CancelBookingResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> CancelBookingResponse | FacetErrorEnvelope | None:
    """ Cancel a confirmed booking.
    ...
    Returns:
        CancelBookingResponse | FacetErrorEnvelope
     """
