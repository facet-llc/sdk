...
from ...models.confirm_booking_request import ConfirmBookingRequest
from ...models.confirm_booking_response import ConfirmBookingResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ConfirmBookingResponse | FacetErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = ConfirmBookingResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ConfirmBookingResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[ConfirmBookingResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> ConfirmBookingResponse | FacetErrorEnvelope | None:
    """ Confirm a held booking with attendee details.
    ...
    Returns:
        ConfirmBookingResponse | FacetErrorEnvelope
     """
