...
from ...models.consume_license_request import ConsumeLicenseRequest
from ...models.consume_license_response import ConsumeLicenseResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ConsumeLicenseResponse | FacetErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = ConsumeLicenseResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ConsumeLicenseResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[ConsumeLicenseResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> ConsumeLicenseResponse | FacetErrorEnvelope | None:
    """ Decrement a license's usage counter.
    ...
    Returns:
        ConsumeLicenseResponse | FacetErrorEnvelope
     """
