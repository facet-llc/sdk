...
from ...models.get_auction_request import GetAuctionRequest
from ...models.get_auction_response import GetAuctionResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetAuctionResponse | None:
    if response.status_code == 200:
        response_200 = GetAuctionResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetAuctionResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetAuctionResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetAuctionResponse | None:
    """ Read one auction with caller-specific high-bidder flag.
    ...
    Returns:
        FacetErrorEnvelope | GetAuctionResponse
     """
