...
from ...models.list_auctions_request import ListAuctionsRequest
from ...models.list_auctions_response import ListAuctionsResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | ListAuctionsResponse | None:
    if response.status_code == 200:
        response_200 = ListAuctionsResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | ListAuctionsResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | ListAuctionsResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | ListAuctionsResponse | None:
    """ List auctions matching the filter set.
    ...
    Returns:
        FacetErrorEnvelope | ListAuctionsResponse
     """
