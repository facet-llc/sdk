...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | UpdateWebhookResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | UpdateWebhookResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | UpdateWebhookResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | UpdateWebhookResponse | None:
    """ Update a webhook subscription's events / callback URL (secret immutable).
    ...
    Returns:
        FacetErrorEnvelope | UpdateWebhookResponse
     """
