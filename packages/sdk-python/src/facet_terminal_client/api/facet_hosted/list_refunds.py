...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | ListRefundsResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | ListRefundsResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | ListRefundsResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | ListRefundsResponse | None:
    """ List the caller's refund tickets with cursor pagination.
    ...
    Returns:
        FacetErrorEnvelope | ListRefundsResponse
     """
