...
from ...models.revoke_license_request import RevokeLicenseRequest
from ...models.revoke_license_response import RevokeLicenseResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | RevokeLicenseResponse | None:
    if response.status_code == 200:
        response_200 = RevokeLicenseResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | RevokeLicenseResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | RevokeLicenseResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | RevokeLicenseResponse | None:
    """ Revoke one of the caller's content licenses (consume then rejects).
    ...
    Returns:
        FacetErrorEnvelope | RevokeLicenseResponse
     """
