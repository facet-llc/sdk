...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> AcceptQuoteResponse | FacetErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = AcceptQuoteResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[AcceptQuoteResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[AcceptQuoteResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> AcceptQuoteResponse | FacetErrorEnvelope | None:
    """ Accept a supplier quote on an RFQ.
    ...
    Returns:
        AcceptQuoteResponse | FacetErrorEnvelope
     """
