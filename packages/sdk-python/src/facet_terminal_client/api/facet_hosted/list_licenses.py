...
from ...models.list_licenses_request import ListLicensesRequest
from ...models.list_licenses_response import ListLicensesResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | ListLicensesResponse | None:
    if response.status_code == 200:
        response_200 = ListLicensesResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | ListLicensesResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | ListLicensesResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | ListLicensesResponse | None:
    """ List the caller's content licenses with cursor pagination.
    ...
    Returns:
        FacetErrorEnvelope | ListLicensesResponse
     """
