...
from ...models.get_webhook_request import GetWebhookRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetWebhookResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetWebhookResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetWebhookResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetWebhookResponse | None:
    """ Retrieve one of the caller's webhook subscriptions (secret hidden).
    ...
    Returns:
        FacetErrorEnvelope | GetWebhookResponse
     """
