...
from ...models.skip_next_run_request import SkipNextRunRequest
from ...models.skip_next_run_response import SkipNextRunResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | SkipNextRunResponse | None:
    if response.status_code == 200:
        response_200 = SkipNextRunResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | SkipNextRunResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | SkipNextRunResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | SkipNextRunResponse | None:
    """ Skip a subscription's next scheduled run.
    ...
    Returns:
        FacetErrorEnvelope | SkipNextRunResponse
     """
