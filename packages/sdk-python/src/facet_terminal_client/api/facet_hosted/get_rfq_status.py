...
from ...models.get_rfq_status_request import GetRfqStatusRequest
from ...models.get_rfq_status_response import GetRfqStatusResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetRfqStatusResponse | None:
    if response.status_code == 200:
        response_200 = GetRfqStatusResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetRfqStatusResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetRfqStatusResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetRfqStatusResponse | None:
    """ Fetch an RFQ request + its quotes.
    ...
    Returns:
        FacetErrorEnvelope | GetRfqStatusResponse
     """
