...
from ...models.find_slots_request import FindSlotsRequest
from ...models.find_slots_response import FindSlotsResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | FindSlotsResponse | None:
    if response.status_code == 200:
        response_200 = FindSlotsResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | FindSlotsResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | FindSlotsResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | FindSlotsResponse | None:
    """ Find bookable slots in a date range.
    ...
    Returns:
        FacetErrorEnvelope | FindSlotsResponse
     """
