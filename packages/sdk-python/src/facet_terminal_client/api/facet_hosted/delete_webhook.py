...
from ...models.delete_webhook_request import DeleteWebhookRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> DeleteWebhookResponse | FacetErrorEnvelope | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[DeleteWebhookResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[DeleteWebhookResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> DeleteWebhookResponse | FacetErrorEnvelope | None:
    """ Remove a webhook subscription.
    ...
    Returns:
        DeleteWebhookResponse | FacetErrorEnvelope
     """
