...
from ...models.get_bid_status_request import GetBidStatusRequest
from ...models.get_bid_status_response import GetBidStatusResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetBidStatusResponse | None:
    if response.status_code == 200:
        response_200 = GetBidStatusResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetBidStatusResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetBidStatusResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetBidStatusResponse | None:
    """ Read the caller's bid history for an auction.
    ...
    Returns:
        FacetErrorEnvelope | GetBidStatusResponse
     """
