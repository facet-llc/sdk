...
from ...models.attest_fulfillment_request import AttestFulfillmentRequest
from ...models.attestation_response import AttestationResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> AttestationResponse | FacetErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = AttestationResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[AttestationResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[AttestationResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> AttestationResponse | FacetErrorEnvelope | None:
    """ Merchant attests that an order was fulfilled, or could not be.
    ...
    Returns:
        AttestationResponse | FacetErrorEnvelope
     """
