...
from ...models.cancel_order_request import CancelOrderRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CancelOrderResponse | FacetErrorEnvelope | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CancelOrderResponse | FacetErrorEnvelope]:
    return Response(
...
def sync_detailed(
    *,
...
) -> Response[CancelOrderResponse | FacetErrorEnvelope]:
    ...
    Args:
        ...
        body (CancelOrderRequest): Pre-fulfillment cancel of the caller's own order. Idempotent on
            an already-cancelled order; a fulfilled/refunded order returns IDEMPOTENCY_CONFLICT.
...
def sync(
    *,
...
) -> CancelOrderResponse | FacetErrorEnvelope | None:
    """ Cancel one of the caller's orders before fulfillment.
    ...
    Returns:
        CancelOrderResponse | FacetErrorEnvelope
     """
