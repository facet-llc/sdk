...
from ...models.graph_path_response import GraphPathResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GraphPathResponse | None:
    if response.status_code == 200:
        response_200 = GraphPathResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GraphPathResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GraphPathResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GraphPathResponse | None:
    """ Find a path between two KG nodes.
    ...
    Returns:
        FacetErrorEnvelope | GraphPathResponse
     """
