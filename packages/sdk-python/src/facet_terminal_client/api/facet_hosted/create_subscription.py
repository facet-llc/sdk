...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CreateSubscriptionResponse | FacetErrorEnvelope | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CreateSubscriptionResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[CreateSubscriptionResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> CreateSubscriptionResponse | FacetErrorEnvelope | None:
    """ Create a recurring subscription with ISO 8601 cadence.
    ...
    Returns:
        CreateSubscriptionResponse | FacetErrorEnvelope
     """
