...
from ...models.list_reservations_request import ListReservationsRequest
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | ListReservationsResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | ListReservationsResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | ListReservationsResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | ListReservationsResponse | None:
    """ List the caller's reservations with cursor pagination.
    ...
    Returns:
        FacetErrorEnvelope | ListReservationsResponse
     """
