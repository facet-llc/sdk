...
from ...models.place_bid_request import PlaceBidRequest
from ...models.place_bid_response import PlaceBidResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | PlaceBidResponse | None:
    if response.status_code == 200:
        response_200 = PlaceBidResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | PlaceBidResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | PlaceBidResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | PlaceBidResponse | None:
    """ Place a max-bid on an auction.
    ...
    Returns:
        FacetErrorEnvelope | PlaceBidResponse
     """
