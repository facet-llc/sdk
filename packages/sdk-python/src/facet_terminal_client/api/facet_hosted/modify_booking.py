...
from ...models.modify_booking_request import ModifyBookingRequest
from ...models.modify_booking_response import ModifyBookingResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | ModifyBookingResponse | None:
    if response.status_code == 200:
        response_200 = ModifyBookingResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | ModifyBookingResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | ModifyBookingResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | ModifyBookingResponse | None:
    """ Move a booking to a different slot.
    ...
    Returns:
        FacetErrorEnvelope | ModifyBookingResponse
     """
