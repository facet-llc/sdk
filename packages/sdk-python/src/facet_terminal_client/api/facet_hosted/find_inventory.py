...
from ...models.find_inventory_request import FindInventoryRequest
from ...models.find_inventory_response import FindInventoryResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | FindInventoryResponse | None:
    if response.status_code == 200:
        response_200 = FindInventoryResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | FindInventoryResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | FindInventoryResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | FindInventoryResponse | None:
    """ Find date-bound inventory units for a resource.
    ...
    Returns:
        FacetErrorEnvelope | FindInventoryResponse
     """
