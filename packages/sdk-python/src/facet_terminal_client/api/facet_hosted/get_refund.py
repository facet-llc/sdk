...
from ...models.get_refund_request import GetRefundRequest
from ...models.get_refund_response import GetRefundResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | GetRefundResponse | None:
    if response.status_code == 200:
        response_200 = GetRefundResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | GetRefundResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | GetRefundResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | GetRefundResponse | None:
    """ Retrieve one of the caller's refund tickets by id.
    ...
    Returns:
        FacetErrorEnvelope | GetRefundResponse
     """
