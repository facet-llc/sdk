...
from ...models.request_human_request import RequestHumanRequest
from ...models.request_human_response import RequestHumanResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | RequestHumanResponse | None:
    if response.status_code == 200:
        response_200 = RequestHumanResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | RequestHumanResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | RequestHumanResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | RequestHumanResponse | None:
    """ Open an escalation ticket for off-tool support.
    ...
    Returns:
        FacetErrorEnvelope | RequestHumanResponse
     """
