...
from ...models.counter_quote_request import CounterQuoteRequest
from ...models.counter_quote_response import CounterQuoteResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CounterQuoteResponse | FacetErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = CounterQuoteResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CounterQuoteResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[CounterQuoteResponse | FacetErrorEnvelope]:
...
def sync(
    *,
...
) -> CounterQuoteResponse | FacetErrorEnvelope | None:
    """ Post a counter-offer message on an RFQ.
    ...
    Returns:
        CounterQuoteResponse | FacetErrorEnvelope
     """
