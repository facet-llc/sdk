...
from ...models.pause_subscription_request import PauseSubscriptionRequest
from ...models.pause_subscription_response import PauseSubscriptionResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | PauseSubscriptionResponse | None:
    if response.status_code == 200:
        response_200 = PauseSubscriptionResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | PauseSubscriptionResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | PauseSubscriptionResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | PauseSubscriptionResponse | None:
    """ Pause a subscription (optionally until a specific date).
    ...
    Returns:
        FacetErrorEnvelope | PauseSubscriptionResponse
     """
