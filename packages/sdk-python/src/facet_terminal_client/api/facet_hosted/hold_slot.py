...
from ...models.hold_slot_request import HoldSlotRequest
from ...models.hold_slot_response import HoldSlotResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | HoldSlotResponse | None:
    if response.status_code == 200:
        response_200 = HoldSlotResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | HoldSlotResponse]:
    return Response(
...
) -> Response[FacetErrorEnvelope | HoldSlotResponse]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | HoldSlotResponse | None:
    """ Place a soft hold on a bookable slot.
    ...
    Returns:
        FacetErrorEnvelope | HoldSlotResponse
     """
