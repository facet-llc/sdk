...
from ...models.cancel_rfq_request import CancelRfqRequest
from ...models.cancel_rfq_response import CancelRfqResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> CancelRfqResponse | FacetErrorEnvelope | None:
    if response.status_code == 200:
        response_200 = CancelRfqResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[CancelRfqResponse | FacetErrorEnvelope]:
    return Response(
...
) -> Response[CancelRfqResponse | FacetErrorEnvelope]:
    """ Cancel an open RFQ.
...
def sync(
    *,
...
) -> CancelRfqResponse | FacetErrorEnvelope | None:
    """ Cancel an open RFQ.
    ...
    Returns:
        CancelRfqResponse | FacetErrorEnvelope
     """
