...
def sync_detailed(
    *,
    ...
    """ Per-host summary of which OMS is connected, which settlement rails are live (read from the live
    PaymentDispatcher registry, never a static list), and which webhook events this site can emit.
