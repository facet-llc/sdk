...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope]:
    return Response(
...
) -> Response[FacetErrorEnvelope]:
    """ Canonical OpenAPI 3.1 spec (YAML). Same body as /v1/openapi.json but in YAML form for human review
    and tooling that prefers YAML.
