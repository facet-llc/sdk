...
from ...models.facet_key_bundle import FacetKeyBundle
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/.well-known/facet-keys.json",
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> FacetErrorEnvelope | FacetKeyBundle | None:
    if response.status_code == 200:
        response_200 = FacetKeyBundle.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[FacetErrorEnvelope | FacetKeyBundle]:
    return Response(
...
) -> Response[FacetErrorEnvelope | FacetKeyBundle]:
...
def sync(
    *,
...
) -> FacetErrorEnvelope | FacetKeyBundle | None:
    """ Public Ed25519 response-signing key bundle.
    ...
    Returns:
        FacetErrorEnvelope | FacetKeyBundle
     """
