...
def sync_detailed(
    *,
    ...
    """ Per-host crawler policy. A Facet Terminal is an API surface for agents, not a set of crawlable
    pages, so this allows all crawlers and points them at agents.txt as the real discovery entry point.
