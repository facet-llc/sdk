...
def sync_detailed(
    *,
    ...
    """ Per-host curated discovery index for LLMs and agents that land on this Terminal directly, before
    ever making a tool call. Points at agents.txt, capabilities, terms, and the OpenAPI spec rather than
    duplicating them.
