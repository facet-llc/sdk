...
def sync_detailed(
    *,
    ...
    """ Per-host agents.txt discovery manifest. Generated per resolved site — points agents at this host's
    Terminal, the trusted KYA issuers, advertised commerce rails, and live capabilities so
    discoverAndConnect(host) resolves in one call.
