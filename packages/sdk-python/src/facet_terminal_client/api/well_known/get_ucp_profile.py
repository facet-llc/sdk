...
def sync_detailed(
    *,
    ...
    """ Per-host UCP (Universal Commerce Protocol) business profile (RFC 8615). Advertises this merchant's
    UCP service endpoints, the llc.facet.x402 + llc.facet.boson_escrow payment handlers, and the ES256
    signing keys. Returns 404 until the operator enables UCP via FACET_UCP_ENABLED.
