...
from ..models.revoke_license_response_stripe_status import RevokeLicenseResponseStripeStatus
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="RevokeLicenseResponse")



@_attrs_define
class RevokeLicenseResponse:
    """ 
        Attributes:
            license_id (str):
            scope (str):
            ...
            stripe_status (RevokeLicenseResponseStripeStatus | Unset):
     """
    ...
    stripe_status: RevokeLicenseResponseStripeStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_stripe_status,  Unset):
            ...
            stripe_status = RevokeLicenseResponseStripeStatus(_stripe_status)




        revoke_license_response = cls(
            license_id=license_id,
            scope=scope,
            price_minor=price_minor,
            currency=currency,
        ...
        revoke_license_response.additional_properties = d
        return revoke_license_response
