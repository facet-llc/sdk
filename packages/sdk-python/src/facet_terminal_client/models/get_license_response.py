...
from ..models.get_license_response_stripe_status import GetLicenseResponseStripeStatus
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="GetLicenseResponse")
...
class GetLicenseResponse:
    """ 
        Attributes:
            ...
            stripe_status (GetLicenseResponseStripeStatus | Unset):
     """
    ...
    stripe_status: GetLicenseResponseStripeStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_stripe_status,  Unset):
            ...
            stripe_status = GetLicenseResponseStripeStatus(_stripe_status)




        get_license_response = cls(
            license_id=license_id,
            scope=scope,
            price_minor=price_minor,
            currency=currency,
        ...
        get_license_response.additional_properties = d
