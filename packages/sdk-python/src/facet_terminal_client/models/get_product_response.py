...
if TYPE_CHECKING:
  from ..models.get_product_response_pack import GetProductResponsePack
...
T = TypeVar("T", bound="GetProductResponse")
...
class GetProductResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pack = GetProductResponsePack.from_dict(d.pop("pack"))
        ...
        get_product_response.additional_properties = d
