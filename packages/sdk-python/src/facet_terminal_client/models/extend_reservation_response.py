...
T = TypeVar("T", bound="ExtendReservationResponse")
...
class ExtendReservationResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        extend_reservation_response = cls(
            reservation_id=reservation_id,
            product_id=product_id,
            qty=qty,
            unit_price=unit_price,
        ...
        extend_reservation_response.additional_properties = d
        return extend_reservation_response
