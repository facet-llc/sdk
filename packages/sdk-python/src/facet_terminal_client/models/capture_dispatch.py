...
from ..models.capture_dispatch_op import CaptureDispatchOp
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="CaptureDispatch")
...
class CaptureDispatch:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        capture_dispatch.additional_properties = d
