...
T = TypeVar("T", bound="UpdateComplianceResponse")



@_attrs_define
class UpdateComplianceResponse:
    """ 
        Attributes:
            product_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_compliance_response = cls(
            product_id=product_id,
            may_contain=may_contain,
            certifications=certifications,
            ftl_listed=ftl_listed,
        ...
        update_compliance_response.additional_properties = d
        return update_compliance_response
