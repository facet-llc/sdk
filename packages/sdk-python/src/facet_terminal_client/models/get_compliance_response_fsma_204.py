...
T = TypeVar("T", bound="GetComplianceResponseFsma204")



@_attrs_define
class GetComplianceResponseFsma204:
    """ 
        Attributes:
            ftl_listed (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_compliance_response_fsma_204 = cls(
            ftl_listed=ftl_listed,
            lot_code_format=lot_code_format,
            kde_support=kde_support,
            cte_support=cte_support,
        ...
        get_compliance_response_fsma_204.additional_properties = d
        return get_compliance_response_fsma_204
