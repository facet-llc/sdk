...
if TYPE_CHECKING:
  ...
  from ..models.product_compliance_allergens import ProductComplianceAllergens
  from ..models.product_compliance_fsma_204 import ProductComplianceFsma204





T = TypeVar("T", bound="ProductCompliance")
...
class ProductCompliance:
    """ 
        Attributes:
            product_id (str):
            allergens (ProductComplianceAllergens):
            fsma_204 (ProductComplianceFsma204):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        allergens = ProductComplianceAllergens.from_dict(d.pop("allergens"))




        fsma_204 = ProductComplianceFsma204.from_dict(d.pop("fsma_204"))
        ...
        product_compliance.additional_properties = d
