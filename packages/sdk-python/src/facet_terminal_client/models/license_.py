...
from ..models.license_stripe_status import LicenseStripeStatus
from ..types import UNSET, Unset
...
class License:
    """ 
        Attributes:
            ...
            stripe_status (LicenseStripeStatus | Unset):
     """
    ...
    stripe_status: LicenseStripeStatus | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_stripe_status,  Unset):
            ...
            stripe_status = LicenseStripeStatus(_stripe_status)
