...
T = TypeVar("T", bound="CreateComplianceResponse")



@_attrs_define
class CreateComplianceResponse:
    """ 
        Attributes:
            product_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_compliance_response = cls(
            product_id=product_id,
            may_contain=may_contain,
            certifications=certifications,
            ftl_listed=ftl_listed,
        ...
        create_compliance_response.additional_properties = d
        return create_compliance_response
